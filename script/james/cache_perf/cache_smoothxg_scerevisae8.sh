...
LOG_DIR="/home/bc526/characterize_pggb/script/cache_perf_scerevisiae8_smoothxg"
...
if [ ${PANGENOME} = "scerevisiae8" ]; then
    ...
    program="./smoothxg  \
    --threads=${NUM_THREADS} \
    --gfa-in=/home/bc526/characterize_pggb/dataset/scerevisiae8/scerevisiae8.fa.gz.smoothxg.gfa\
    --smoothed-out=scerevisiae8.fa.gz.smoothxg.gfa \
